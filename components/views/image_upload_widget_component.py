...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier : str):
        ...
        self.image_upload_input = FileInput(page,f'{identifier}-image-upload-widget-input', 'Image input')
    ...
    def check_visible(self, is_image_uploaded: bool):
        ...
        self.image_upload_info_title.have_text('Tap on "Upload image" button to select file')

        self.image_upload_info_description.check_visible()
        self.image_upload_info_description.have_text('Recommended file size 540X300')
        ...
        if not is_image_uploaded:
            self.preview_empty_view.check_visible('No image selected', 'Preview of selected image will be displayed here')
